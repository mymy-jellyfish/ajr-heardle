...
4. In the `index.html` file, change every instance of 'The Weeknd' to your artist. You can find and replace all by hitting command+option+F on Mac (I don't know what the shortcut is on Windows).
5. In the `index.html` file, there is a long link to a photo of The Weeknd. Replace every instance of this link with a URL to a photo of your choice.
